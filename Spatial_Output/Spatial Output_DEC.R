...
files <- list.files(path="DEC/", pattern="asc", all.files=FALSE, full.names=TRUE,recursive=TRUE)
...
save_plot("Spatial_DEC_mean.pdf", p, base_height = 8, base_width = 6)
save_plot("Spatial_DEC_max.pdf", p1, base_height = 8, base_width = 6)
